        ...
        <div class="content-container">
            <div class="content-wrapper">
                <div class="main-content">
                    <h3 class="byteVote-text">BYTEVote</h3>
                    <p class=" text1 w-100 text-center text-wrap">Brackets of Young Technologists Escalating Through Network Officer Election 2025</p>
                    <button class="btn btn-light" onclick="GoToLogin()">Sign-in To Vote</button>
                </div>
...
<script>
    function GoToLogin() {
        ...
        window.location.href = "vote/login.php";
    }
